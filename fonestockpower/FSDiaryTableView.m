...
@implementation FSDiaryTableView
- (void)setDelegate:(id<FSDiaryTableViewDelegate>)delegate {
    _delegate = delegate;
}
...
- (void)updateConstraints {
    ...
    NSString *layoutString = [NSString stringWithFormat:@"H:|[_fixedTableView(%d)][_mainScrollView]|", (int)(_fixedColumnSize * [[_delegate columnsInFixedTableView] count])];
    ...
    int mainViewWidth = (int)(_mainColumnSize * [[_delegate columnsInMainTableView] count] + 50);
...
-(UIView *)MaintableViewForHeader{
    ...
    for (int i = 0; i < [columnsName count]; i++) {
        ...
        if (i == 0) {
            ...
            label = [[UILabel alloc] initWithFrame:CGRectMake(i * _mainColumnSize, 0, _mainColumnSize, 44)];
        }else if (i == 3){
            label = [[UILabel alloc] initWithFrame:CGRectMake(i * _mainColumnSize, 0, _mainColumnSize * 1.5, 44)];
        }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    FSDiaryCell *cell = nil;
    
    if ([tableView isEqual:_fixedTableView]) {
        
        static NSString *CellIdentifier = @"ActionPlanFixedViewCell";
        
        cell = (FSDiaryCell *)[tableView dequeueReusableCellWithIdentifier:CellIdentifier];
        
        if (cell == nil) {
            
            NSArray *columnsName = [_delegate columnsInFixedTableView];
            
            cell = [[FSDiaryCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier AndLabelAmount:(int)[columnsName count]+2];
        ...
        if (cell == nil) {
            ...
            cell = [[FSDiaryCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier AndLabelAmount:(int)[columnsName count]];
        ...
        for (int i = 0; i < [cell.labels count]; i++) {
            ...
            if (i == 0) {
                ...
                label.frame = CGRectMake(i * _mainColumnSize, 0, _mainColumnSize, 44);
            }else if (i == 3){
