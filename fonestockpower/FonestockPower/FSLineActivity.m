...
//  FonestockPower
//
//  Created by Derek on 2014/12/17.
//  Copyright (c) 2014年 Fonestock. All rights reserved.
//

#import "FSLineActivity.h"
@interface FSLineActivity ()
@property (copy) NSString *text;
@property (strong) NSURL *url;
@property (strong) UIImage *image;
@end

@implementation FSLineActivity
{
...
{
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://itunes.apple.com/tw/app/line/id443904275?ls=1&mt=8"]];
}
