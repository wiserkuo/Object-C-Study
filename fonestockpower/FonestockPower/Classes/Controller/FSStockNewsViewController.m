...
#define SECTORID 160
#define PARENTID 596
#define TITLENAME @"股市新聞"

@interface FSStockNewsViewController ()<UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate, UIActionSheetDelegate, FSRadioButtonSetDelegate>{
...
@implementation FSStockNewsViewController
