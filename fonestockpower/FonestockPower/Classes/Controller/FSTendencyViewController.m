...
#define SECTORID 167
#define PARENTID 597
#define TITLENAME @"盤勢分析"

@interface FSTendencyViewController ()<UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate, UIActionSheetDelegate, FSRadioButtonSetDelegate>{
...
@implementation FSTendencyViewController
