//
//  FSGeneralNewsViewController.m
//  FonestockPower
//
//  Created by Michael.Hsieh on 2015/1/13.
...
#define SECTORID 151
#define PARENTID 594
#define TITLENAME @"一般新聞"

@interface FSGeneralNewsViewController ()<UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate, UIActionSheetDelegate, FSRadioButtonSetDelegate>{
...
@implementation FSGeneralNewsViewController
...
//    if (![NewsObject sharedInstance].sectorID) {
//        [NewsObject sharedInstance].sectorID = SECTORID;
//        [dataModel.newsDataModel sendPacketWithSectorID:SECTORID];
//    }else{
