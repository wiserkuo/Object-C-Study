...
{
    if(_lowerValue < _sliderMin && !_upperFlag){
        _lowFlag = YES;
    }else{
        _lowFlag = NO;
    }
    
    if(_upperValue > _sliderMax && !_lowFlag){
        _upperFlag = YES;
    }else{
        _upperFlag = NO;
    }

    if(_upperFlag && _lowerValue < _sliderMin){
        _lowerValue = _sliderMin;
    }else if(_lowFlag && _upperValue > _sliderMax){
        _upperValue = _sliderMax;
    }else{
