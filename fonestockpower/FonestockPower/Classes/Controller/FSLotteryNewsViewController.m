...
#define SECTORID 177
#define PARENTID 173
#define TITLENAME @"彩券發票"

@interface FSLotteryNewsViewController ()<UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate, UIActionSheetDelegate, FSRadioButtonSetDelegate>{
...
@implementation FSLotteryNewsViewController
