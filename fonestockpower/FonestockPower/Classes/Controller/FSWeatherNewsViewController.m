...
#define SECTORID 174
#define PARENTID 172
#define TITLENAME @"氣象概況"

@interface FSWeatherNewsViewController ()<UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate, UIActionSheetDelegate, FSRadioButtonSetDelegate>{
...
@implementation FSWeatherNewsViewController
