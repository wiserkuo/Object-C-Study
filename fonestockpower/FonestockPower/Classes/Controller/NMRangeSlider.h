...
@property(assign, nonatomic) float sliderMin;
// default 1.0
@property(assign, nonatomic) float maximumValue;
@property(assign, nonatomic) float sliderMax;
...
@property(assign, nonatomic) BOOL lowFlag;
@property(assign, nonatomic) BOOL upperFlag;
