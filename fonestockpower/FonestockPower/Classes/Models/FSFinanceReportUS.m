...
<<<<<<< HEAD
            [db executeUpdate:@"INSERT INTO FinanceReport(DataDate, Symbol, FieldName, Amount, ReportType) VALUES(?,?,?,?,?)",[NSNumber numberWithInt:balance.dataDate], identCodeSymbol,[NSString stringWithFormat:@"%f",balance.shortTermInvestments.calcValue], @"BalanceSheet"];
=======
...
>>>>>>> b83da3dbaadfae3956a2116f6ea8b8781383addf
