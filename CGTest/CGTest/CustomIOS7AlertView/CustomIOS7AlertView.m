...
- (UIView *)createContainerView
{
    ...
    if ([_titleLabel.text isEqualToString:@""]){
        ...
        if (containerView == NULL) {
            containerView = [[UIView alloc] initWithFrame:CGRectMake(0, 35, 300, 150)];
        }
    }
...
//        [closeButton setTitleColor:[UIColor colorWithRed:0.0f green:0.0f blue:1.0f alpha:0.5f] forState:UIControlStateHighlighted];
...
- (CGSize)countDialogSize
{
    ...
    if ([_titleLabel.text isEqualToString:@""]) {
        ...
        dialogHeight = containerView.frame.size.height + buttonHeight + buttonSpacerHeight+35;
    }
