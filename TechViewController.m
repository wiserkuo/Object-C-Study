...
-(void)setDrawView
{
    ...
    if([drawTopView.dataArray count] * widthRange > topScrollView.frame.size.width){
       ...
       // [monthView setBackgroundColor:[UIColor redColor]];
        //[drawTopView setBackgroundColor:[UIColor grayColor]];
        ...
        [drawTopView setFrame:CGRectMake(0, 0, topScrollView.frame.size.width, topScrollView.frame.size.height - 24)];
        [monthView setFrame:CGRectMake(0, topScrollView.frame.size.height - 24, topScrollView.frame.size.width, 24)];
...
{
    double dashHeight = (topRightView.frame.size.height - topAndBottomHeight * 3.5) / 5.75;
    [priceLabel1 setFrame:CGRectMake(5,topAndBottomHeight, 80, topAndBottomHeight)];
    [priceLabel2 setFrame:CGRectMake(5,topAndBottomHeight + (1 * dashHeight), 80, topAndBottomHeight)];
    [priceLabel3 setFrame:CGRectMake(5,topAndBottomHeight + (2 * dashHeight), 80, topAndBottomHeight)];
    [priceLabel4 setFrame:CGRectMake(5,topAndBottomHeight + (3 * dashHeight), 80, topAndBottomHeight)];
    [priceLabel5 setFrame:CGRectMake(5,topAndBottomHeight + (4 * dashHeight), 80, topAndBottomHeight)];
    [priceLabel6 setFrame:CGRectMake(5,topAndBottomHeight + (5 * dashHeight), 80, topAndBottomHeight)];
    [priceLabel7 setFrame:CGRectMake(5,topAndBottomHeight + (6 * dashHeight) - topAndBottomHeight / 3, 80, topAndBottomHeight)];
}
